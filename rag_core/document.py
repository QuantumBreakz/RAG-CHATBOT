...
class DocumentProcessor:
    ...
    @staticmethod
    def process_document(uploaded_file, file_bytes=None, chunk_size=None, chunk_overlap=None):
        ...
        try:
            ...
            if uploaded_file.size > MAX_FILE_SIZE:
                ...
                logger.error(f"File size exceeds limit of {MAX_FILE_SIZE / (1024 * 1024)} MB")
                return []
